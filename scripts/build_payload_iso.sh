...
cp "$repository_root/guest/run-gui-ci.cmd" "$staging_directory/run-gui-ci.cmd"
cp "$repository_root/guest/run-gui-acceptance.ps1" "$staging_directory/run-gui-acceptance.ps1"
cp "$repository_root/guest/capture-desktop.ps1" "$staging_directory/capture-desktop.ps1"
cp "$repository_root/guest/run-gui-task.vbs" "$staging_directory/run-gui-task.vbs"
